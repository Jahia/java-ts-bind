...
mkdir -p npm-modules-engine/build npm-modules-engine/build/sources npm-modules-engine/build/jar-symbols

# Define the source directories
jdk11_dir="npm-modules-engine/build/sources/jdk11"
jcr2_dir="npm-modules-engine/build/sources/jcr2"
servlet_api_dir="npm-modules-engine/build/sources/servlet-api"
felix_framework_dir="npm-modules-engine/build/sources/felix-framework"
npm_modules_engine_dir="npm-modules-engine/build/sources/npm-modules-engine"
jahia_private_dir="npm-modules-engine/build/sources/jahia-private"
jar_symbols_dir="npm-modules-engine/build/jar-symbols"
